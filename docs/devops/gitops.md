...
- `apps/ai-services/base`：AI 服务组，包括共享 PostgreSQL（`longhorn-fast-1replica`）、Metapi、Aether（Rust Pioneer）+ Redis、Kiro、CLIProxyAPI、Grok2API、GPT-Load、Codex2API，以及加密后的 `secret-sealed.yaml`。
...
- Metapi、Aether、Kiro、CLIProxyAPI、Grok2API、GPT-Load、Codex2API 的 API Key、管理 Token、数据库口令与 OAuth / Refresh Token。
