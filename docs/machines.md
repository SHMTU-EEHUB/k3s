...
| 集群内 Mixed 显式代理 | `mihomo-proxy-nodeport`   |     `7897` |        - | ClusterIP，仅供集群内容器使用                  |
...
| 服务              | 地址                | 用途            |
| ----------------- | ------------------- | --------------- |
| Aether            | `100.100.1.2:30884` | Aether AI 网关  |
| Mihomo Controller | `100.100.1.2:30910` | Mihomo 控制 API |
| Mihomo Web UI     | `100.100.1.2:30911` | Mihomo Web UI   |
