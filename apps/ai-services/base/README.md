...
- `cli-proxy-api` 通过 initContainer 将 `config.yaml` 复制到 PVC，并初始化持久化 `auths` 目录；当前固定使用官方 `eceasy/cli-proxy-api:v7.2.143@sha256:c6fef08792488785b380fa776bcaf872e0c60a3f74fcb77effcfab74362ad70d`（2026-08-27 核验；index `sha256:c6fef08792488785b380fa776bcaf872e0c60a3f74fcb77effcfab74362ad70d`，`linux/amd64` `sha256:b727e02fae58cabe5917eba6cc6f04b582d374001344d3c2930af6e321649722`；release：https://github.com/router-for-me/CLIProxyAPI/releases/tag/v7.2.143）。该版修复协议翻译、工具与插件，无数据迁移；`/CLIProxyAPI/config.yaml`、`/root/.cli-proxy-api`、端口 `8317` 与现有 PVC 保持兼容。
...
- `codex2api` 使用 initContainer 幂等创建 `codex2api` 数据库与用户；当前固定使用 `ghcr.io/james-6-23/codex2api:2.8.4@sha256:72554ca0c1eec84a418db46969265e109c958a9d8b5f9a9eed349c7ae83fba8b`（2026-08-27 核验；index `sha256:72554ca0c1eec84a418db46969265e109c958a9d8b5f9a9eed349c7ae83fba8b`，`linux/amd64` `sha256:47033b5970693439fb0eb1b1f7cf2c560c6f9bd88ef19ba6991e92be92b19a2c`；release：https://github.com/james-6-23/codex2api/releases/tag/v2.8.4）。该版支持可回滚的自动增量数据库迁移，默认关闭新增高风险功能；Codex zstd 请求压缩默认开启，但可通过设置关闭。端口 `8080`、`/health`、Redis 配置与 `/data` 路径保持兼容。
...
- 截至 2026-08-27，Gemini `latest`、HaloWebUI `main`、WA `latest` 的 registry digest 未变化，均按 `tag+digest` 跟踪滚动标签；Aether、Metapi、Kiro、Copilot、Notion 与 ChatGPT 当前已是可确认支持的最新版本。
