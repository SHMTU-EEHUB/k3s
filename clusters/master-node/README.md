...
- `ai-postgresql-secret`、`metapi-secret`、`aether-secret`、`ds2api-secret`、`kiro-rs-secret`、`cli-proxy-api-secret`、`grok2api-secret`、`gpt-load-secret`、`codex2api-secret` 由 `apps/ai-services/base/secret-sealed.yaml` 解封生成。
